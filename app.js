...
const PROGRAM_MATH_PAGES=['7–14','15–20','21–26','27–30','31–34','35–40','41–45','46–50','51–56','57–61','62–66','67–70','71–78','79–86','87–94','95–98','99–102','103–112','113–122','123–128','129–134','135–140','141–146','147–152','153–158','159–164','165–170','171–176','177–182','183–188','189–196','197–202','203–210','211–216','217–222','223–228','229–234','235–240','241–246','247–252','253–258','259–264','265–270','271–274','275–280','281–287','288–294','295–300','301–308','309–314','315–320','321–326','327–332','333–338','339–343','344–348','349–352','353–356','357–364','365–368'];
...
const PROGRAM_DAYS=PROGRAM_MATH.map((math,index)=>({day:index+1,date:addDaysKey(PROGRAM_START,index),items:[
  {subject:'Matematik',range:math[0],topic:math[1],practice:`Defter: s. ${PROGRAM_MATH_PAGES[index]}`,videoCount:programVideoCount(math[0]),durationSeconds:PROGRAM_MATH_SECONDS[index]},
